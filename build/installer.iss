...
OutputDir=Output
OutputBaseFilename=LogNotes-Setup-{#MyAppVersion}
...
[Files]
Source: "..\dist\LogNotes\LogNotes.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\dist\LogNotes\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
